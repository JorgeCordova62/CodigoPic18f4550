...
OPER1_16B    RES 1   		;reserva dos byte en RAM a partir de la dirección 0x000
OPER1_16A    RES 1   		;reserva dos byte en RAM a partir de la dirección 0x000
OPER2_16B    RES 1   		;reserva dos byte en RAM a partir de la dirección 0x002
OPER2_16A    RES 1   		;reserva dos byte en RAM a partir de la dirección 0x002
RESUL_16A    RES 1   		;reserva dos byte en RAM a partir de la dirección 0x004
RESUL_16B    RES 1   		;reserva dos byte en RAM a partir de la dirección 0x004
;--------inicia código----------------------------------------------------------
...
RST    CODE 0x00        		;RST: etiqueta, identifica la dirección de la memoria
     ...
     movwf OPER1_16A, 0 	;mueve el contenido del WREG a la dirección de
     ...
     movwf OPER2_16A, 0 	;mueve el contenido del WREG a la dirección de
...
;----suma parte alta----------------------------------------------------------------------------------------------
        movf OPER1_16A, 0, 1	;mueve la parte alta del primer operando el reg. W
        addwfc OPER2_16A, 0, 1 	;suma el contenido de W mas acareo con parte alta
        movwf RESUL_16A, 1     	;del operando dos guarda resultado en ella memoria
                                		;0x005
        END
